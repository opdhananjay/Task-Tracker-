...
const TestCaseTransaction = ({
  ...
  const onSubmit = async (data) => {
    ...
    if (TestCasesSaveUpdateService) {
      ...
      const response =
        await TestCasesSaveUpdateService(payload);
        ...
        <div className="grid grid-cols-1 gap-4 w-full">
          ...
          <div className="flex flex-col items-start gap-2 space-x-2">
            ...
            <input
              ...
              disabled={isViewMode || !isDeveloper}
            />
          ...
          <div>
            ...
            <select
              className="w-full border flex flex-1 border-gray-300 rounded-md px-2 p-2 text-sm"
              defaultValue={testCase?.developerStatus || ""}
              disabled={isViewMode || !isDeveloper}
          ...
          <div>
            ...
            <select
              className="w-full border flex flex-1 border-gray-300 rounded-md px-2 p-2 text-sm"
              defaultValue={testCase?.testerStatus || ""}
              disabled={isViewMode || !isTester}
